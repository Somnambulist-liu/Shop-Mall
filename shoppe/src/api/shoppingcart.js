...
//批量删除购物车
export const $shoppingcart_delete_batch = async (params)=>{
  let ret = await $delete('shopcart/deleteBatch',params)
  return ret
}
...
export const $shoppingcart_addOrder = async (params)=>{
  let ret = await $post('orders/addOrder',params)
  return ret
}

// 获取用户订单
export const $order_getUserOrder = async (params)=>{
  let ret = await $get('orders/getUserOrder',params)
  return ret
}
